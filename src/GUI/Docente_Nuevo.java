 ...
 * @author mayra
 */
public class Docente_Nuevo extends javax.swing.JDialog {
    ...
    public Docente_Nuevo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(26, 26, 26)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tipoP, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
        ...
        if (Validar() == 0) {
            try {
                ...
                Docente_Auxiliar_Dominio objeto = new Docente_Auxiliar_Dominio(null,
                        ...
                        Integer.parseInt(fono.getText()), 
                        (String)tipoP.getSelectedItem(),
                        Integer.parseInt(Nmaterias.getText()),
                        horario.getText(),codd,
                ...
                opera.Guardar("academico", "docente_auxiliar", campos1, val1);
            } catch (Exception ex) {
                Logger.getLogger(Docente_Nuevo.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public boolean Validez() {
        ...
        if (a == false) {
            ...
            lista = consu.tablaDocenteAuxiliar("academico", identificacion.getText());
            System.out.println(" bebe biggi " + lista.size());
            if (lista.size() < 1) {
                a = true;
            } else {
                a = false;
                error = error + "Cedula ya existe!";
            }
        }
        return a;
    }

    public void Calculo(String hora) {
         String codd="";
                if("AUXILIAR".equals((String)tipoP.getSelectedItem())){
                    codd="DA";
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Docente_Nuevo dialog = new Docente_Nuevo(new javax.swing.JFrame(), true);
